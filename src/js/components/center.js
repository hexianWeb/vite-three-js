...
export default class Center {
   ...
   * @param {boolean} [config.top=false] - Align to top
   * @param {boolean} [config.right=false] - Align to right
   * @param {boolean} [config.bottom=false] - Align to bottom
   * @param {boolean} [config.left=false] - Align to left
   * @param {boolean} [config.front=false] - Align to front
   * @param {boolean} [config.back=false] - Align to back
   * @param {boolean} [config.disable=false] - Disable all centering
   * @param {boolean} [config.disableX=false] - Disable centering on X axis
   * @param {boolean} [config.disableY=false] - Disable centering on Y axis
